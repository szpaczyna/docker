...
if [[ "$(id -u)" == "0" ]]; then
  ...
  if [[ -n "$TAKE_FILE_OWNERSHIP" ]]; then
    chown -R 1000:0 /usr/share/elasticsearch/{data,logs,config}
  fi
fi

touch /usr/share/elasticsearch/config/jvm.options
chmod 777 /usr/share/elasticsearch/config/jvm.options
