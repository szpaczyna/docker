...
var (
	loginURLPattern = "%s://%s/index.php?login"
	statsURLPattern = "%s://%s/api.php?summaryRaw&overTimeData&topItems&recentItems&getQueryTypes&getForwardDestinations&getQuerySources&jsonForceObject"
)
